...
class Mager : Enemy {
    ...
    required init(scalar : Double, defaultYPosition: CGFloat, defaultXPosition: CGFloat, parent: SKNode, value1: Double, value2: Double, scene: GameScene) {
        ...
        super.init(scalar: scalar, imageName: "mage_standing_000", textureAtlas: GameTextures.sharedInstance.spiritAtlas, defaultYPosition: defaultYPosition, value1: value1, value2: value2, scene: scene)
        ...
        let actionOpenProjectile: SKAction = SKAction.run({
            ...
            if self != nil {
                let energyBall: MageEnergyBall = self?.projectiles.popLast() as! MageEnergyBall
    ...
    override func setupTraitsWithScalar(_ scalar: Double) {
        ...
        self.lineOfSight = 600 * ScaleBuddy.sharedInstance.getGameScaleAmount(false)
